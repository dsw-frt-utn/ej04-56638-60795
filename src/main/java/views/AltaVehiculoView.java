...
public class AltaVehiculoView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("CapacidadCarga:");

        jLabel6.setText("Sucursal:");

        jLabel7.setText("TipoVehiculo:");

        jLabel8.setText("KwhBase:");

        jLabel9.setText("KmPorLitro:");

        jLabel10.setText("LitrosExtra:");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(cmbTipoVehiculo, 0, 199, Short.MAX_VALUE))
                        .addGap(53, 53, 53))
                    .addGroup(layout.createSequentialGroup()
...
try {
        ...
        double capacidad = Double.parseDouble(jTextField5.getText());
        
        
        domain.Sucursal sucursal = data.Persistencia.getSucursales().get(cmbSucursal.getSelectedIndex());
        
        String tipoSeleccionado = cmbTipoVehiculo.getSelectedItem().toString();
        
        
        domain.Vehiculo nuevoVehiculo;
        
        if (tipoSeleccionado.equals("ELECTRICO")) {
            double kwh = Double.parseDouble(jTextField6.getText());
            nuevoVehiculo = new domain.VehiculoElectrico(patente, marca, modelo, anio, capacidad, sucursal, kwh);
        } else {
            double kmLitro = Double.parseDouble(jTextField7.getText());
            double litrosExtra = Double.parseDouble(jTextField8.getText());
            nuevoVehiculo = new domain.VehiculoCombustible(patente, marca, modelo, anio, capacidad, sucursal, kmLitro, litrosExtra);
        }
        
        // 3. Guardar en la base de datos simulada
        ...
        javax.swing.JOptionPane.showMessageDialog(this, "Error: Verifique que los campos numéricos sean válidos.", "Error de validación", javax.swing.JOptionPane.ERROR_MESSAGE);
